...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2016 at 04:48 AM
...
--
-- Table structure for table `rb_agen`
--

CREATE TABLE `rb_agen` (
...
--
-- Dumping data for table `rb_agen`
--

INSERT INTO `rb_agen` (`id_agen`, `username`, `password`, `nama_agen`, `tempat_lahir`, `tanggal_lahir`, `no_ktp_sim`, `email`, `alamat_lengkap`, `kota`, `provinsi`, `kode_pos`, `telp_hp`, `waktu_daftar`, `aktif`) VALUES
(1, 'willy', '181676ffcb279fc91cfb9cb5f07be65b23224b05059f9f2ff0158aa520693a805496be090242c3cdf56c0463f278aba4b01c7115ea356eda346ef8270e402696', 'Willy Fernando', 'Padang', '1988-06-23', '54431236786577576', 'willy.fernando@gmail.com', 'Jl. Tabek Gadang, Tika Raya', 'Payakumbuh', 'Sumatera Barat', 26125, '083267129800', '2016-08-31 09:14:08', 'Y'),
(2, 'laura', 'ca946a52760d2c5e2670aa899019f09638e72462d8a9ff272dffb16d14e3873457ce6be0a3ecf205fdb0c8141bbe560b01240f1f1307e31b231cb18428ec5974', 'Laura Hikmah', 'Sialang', '1994-02-14', '657234421231231', 'laura.hikmah@gmail.com', 'Jl. Angkasa Puri, Perundam 5, Tunggul Hitam', 'Padang', 'Sumatera Barat', 25678, '082176891233', '2016-08-31 09:18:52', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `rb_agen_order`
--

CREATE TABLE `rb_agen_order` (
  `id_agen_order` int(10) NOT NULL,
  `id_agen` int(5) NOT NULL,
...
--
-- Dumping data for table `rb_agen_order`
--

INSERT INTO `rb_agen_order` (`id_agen_order`, `id_agen`, `id_produk`, `jumlah`, `keterangan`, `waktu_order`) VALUES
(1, 1, 2, 12, 'Sudah dibayar Lunas,..', '2016-08-31 09:15:23'),
(2, 1, 1, 10, 'Sudah dibayar Lunas,..', '2016-08-31 09:15:36'),
(3, 2, 2, 5, 'Sudah dibayar Lunas,..', '2016-08-31 09:19:07');

-- --------------------------------------------------------

--
-- Table structure for table `rb_bonus_ro`
--

CREATE TABLE `rb_bonus_ro` (
  `id_bonus_ro` int(10) NOT NULL,
  `username` varchar(50) NOT NULL,
  `bonus_downline` varchar(50) NOT NULL,
...
--
-- Table structure for table `rb_bonus_tabungan`
--

CREATE TABLE `rb_bonus_tabungan` (
  `id_bonus_tabungan` int(10) NOT NULL,
  `id_tabungan_bayar` int(10) NOT NULL,
  `username` varchar(50) NOT NULL,
  `jumlah_bonus` int(10) NOT NULL,
  `waktu_masuk` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `rb_bonus_tabungan`
--

INSERT INTO `rb_bonus_tabungan` (`id_bonus_tabungan`, `id_tabungan_bayar`, `username`, `jumlah_bonus`, `waktu_masuk`) VALUES
(1, 3, 'robby', 3500, '2016-08-31 09:19:47');

-- --------------------------------------------------------

--
-- Table structure for table `rb_distributor`
--

CREATE TABLE `rb_distributor` (
...
--
-- Dumping data for table `rb_distributor`
--

INSERT INTO `rb_distributor` (`id_distributor`, `username`, `password`, `nama_distributor`, `tempat_lahir`, `tanggal_lahir`, `no_ktp_sim`, `email`, `alamat_lengkap`, `kota`, `provinsi`, `kode_pos`, `telp_hp`, `waktu_daftar`, `aktif`) VALUES
(1, 'distributor', 'e0a09e5afefb473d129daa1640976f662b5e030e54db4e87a6252659e4452758782dd27b649e4d2734d96443d7852bdc764762c1d587b95e60905e5e740a5d56', 'Robby Distributor', 'Padang', '1989-05-06', '6734563454533435', 'distributor@gmail.com', 'Jl Angkasa Puri, Tunggul Hitam', 'Padang', 'Sumatera Barat', 26125, '081267771344', '2016-11-05 19:33:16', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `rb_distributor_order`
--

CREATE TABLE `rb_distributor_order` (
  `id_distributor_order` int(10) NOT NULL,
  `id_distributor` int(5) NOT NULL,
  `id_produk` int(5) NOT NULL,
  `jumlah` int(10) NOT NULL,
  `keterangan` text NOT NULL,
...
--
-- Dumping data for table `rb_distributor_order`
--

INSERT INTO `rb_distributor_order` (`id_distributor_order`, `id_distributor`, `id_produk`, `jumlah`, `keterangan`, `waktu_order`) VALUES
(1, 1, 1, 6, 'Lunas', '2016-11-05 20:32:03'),
(2, 1, 2, 7, 'Lunas', '2016-11-05 20:42:26'),
(4, 1, 2, 10, 'Lunas,...', '2016-11-07 09:47:53');

-- --------------------------------------------------------

--
-- Table structure for table `rb_foot`
--

CREATE TABLE `rb_foot` (
  `id_foot` int(11) NOT NULL,
  `username` varchar(100) NOT NULL,
  `totfoot_left` int(11) NOT NULL,
  `totfoot_right` int(11) NOT NULL,
  `totfoot_day` date NOT NULL,
  `bonus_pasangan` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rb_foot`
--

INSERT INTO `rb_foot` (`id_foot`, `username`, `totfoot_left`, `totfoot_right`, `totfoot_day`, `bonus_pasangan`) VALUES
(1, 'robby', 4, 8, '2016-08-31', 100000),
(2, 'asep123', 7, 0, '2016-08-31', 100000),
(3, 'robby', 2, 1, '2016-09-15', 100000),
(4, 'tommy', 1, 1, '2016-09-15', 100000),
(13, 'tommy', 1, 0, '2016-12-12', 100000),
(12, 'robby', 1, 0, '2016-12-12', 100000);

-- --------------------------------------------------------

--
-- Table structure for table `rb_foot_detail`
--

CREATE TABLE `rb_foot_detail` (
  `id_foot` int(11) NOT NULL,
  `username` varchar(100) NOT NULL,
...
--
-- Dumping data for table `rb_foot_detail`
--

INSERT INTO `rb_foot_detail` (`id_foot`, `username`, `downline`, `sponsor`, `posisi`) VALUES
(1, 'robby', 'tommy', 'robby', 0),
(27, 'robby', 'robby1', 'robby', 0),
(7, 'robby', 'dewiit', 'robby', 1),
(15, 'asep123', 'dingding', 'asep123', 0),
(28, 'tommy', 'robby1', 'robby', 0),
(26, 'robby', 'laura', 'robby', 0),
(13, 'tommy', 'laura', 'robby', 1);
...
CREATE TABLE `rb_konsumen` (
  ...
  `peringkat` varchar(60) NOT NULL,
  `tot_ref` int(6) NOT NULL,
  `totfoot_left` int(6) NOT NULL,
  `totfoot_right` int(6) NOT NULL,
  `totfoot_left_day` int(10) NOT NULL,
  `totfoot_right_day` int(10) NOT NULL,
  `totfoot_update_day` date NOT NULL,
...
INSERT INTO `rb_konsumen` (`id_konsumen`, `id_paket`, `kode_konsumen`, `sponsor`, `upline`, `posisi`, `username`, `foot1`, `foot2`, `password`, `nama_lengkap`, `email`, `jenis_kelamin`, `tanggal_lahir`, `no_ktp`, `alamat_lengkap`, `ahli_waris`, `kota`, `provinsi`, `no_hp`, `nama_bank`, `no_rekening`, `rekning_virtual`, `atas_nama`, `peringkat`, `tot_ref`, `totfoot_left`, `totfoot_right`, `totfoot_left_day`, `totfoot_right_day`, `totfoot_update_day`, `harga_paket`, `tanggal_daftar`) VALUES
(1, 2, 'cvDp48oIG73E', '', '', '', 'robby', 'tommy', 'dewiit', '882c306525a9f885466520ba2aa6b10377b029cb569311fc17161d40df6e1bab7eb6103fcf567ce3a1375e77cc7db1928efec90cd0a379303fc2adb159bb1d14', 'Robby Prihandaya', 'robby.prihandaya@gmail.com', 'Laki-laki', '1989-05-06', '5465234123123123', 'Jl. Angkasa Puri, Perundam 5, Tunggul Hitam, Padang, Sumatera Barat, Indonesia', 'Muhammad Arsenio', 'Padang', 'Sumatra Barat', '081267771344', 'BRI', '540011132323112', '126355234234', 'Robby Prihandaya', '', 10, 8, 8, 4, 1, '2016-12-12', 1500000, '2016-08-31'),
(2, 1, 'M7mbwpLr5Va1', 'robby', 'tommy', '1', 'laura', '', '', 'ca946a52760d2c5e2670aa899019f09638e72462d8a9ff272dffb16d14e3873457ce6be0a3ecf205fdb0c8141bbe560b01240f1f1307e31b231cb18428ec5974', 'Laura Hikmah Izzatin Nissa', 'laura.izatin.nissa@gmail.com', 'Perempuan', '1990-05-05', '6234523423423423', 'Jl. Angkasa Raya, Lubuk Begalung', 'Yeni Ermawati', 'Padang', 'Sumatera Barat', '081267771399', 'Mandiri', '5473452342213', '', 'Laura Hikmah Izzatin', '', 0, 0, 0, 0, 0, '2016-12-12', 1500000, '2016-09-15'),
(3, 2, 'NrqVw7yILwJs', 'robby', 'robby', '0', 'tommy', 'robby1', 'laura', 'e3bb0d1fb8d4d0aa070f22a9f73c975222449bb5466dc89033f66a8be07d6e8345308aa298e78066871c6844964e6b63f7be4327525c5025001c76b94310e2f2', 'Tommy Utama', 'tommy.utama@gmail.com', 'Laki-laki', '1985-08-18', '6565234123123110', 'Jl. Lubuk Begalung, Sumatera Barat', 'Claudio Kembario', 'Padang', 'Sumatera Barat', '081266881244', 'BNI', '65452342343', '', 'Tommy Utama', '', 0, 4, 1, 4, 0, '2016-12-12', 4000000, '2016-08-31'),
(4, 2, 'hchCapUj7oVS', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(5, 3, 'qH8quRAqt2yw', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(6, 3, 'sFO7Spmmjzyy', 'robby', 'robby', '1', 'dewiit', '', '', 'af9f95fb734ca6abb2d02a6a169eca2bbf33feb3c25ed266e4129cbed937150699954d72dcb44fee7c9e9acebaf4e7283aabc64a6e56f1b8e6a5a0e8e0551324', 'Dewiit Safitri', 'dewiit.safitri@gmail.com', 'Perempuan', '1989-03-18', '5465234123123111', 'Jl. Linggar Jati 6, Perupuk Tabing', 'Muhammad Orlando', 'Padang', 'Sumatera Barat', '082173054500', 'BCA', '562342423423', '', 'Dewiit Safitri', '', 0, 1, 0, 1, 0, '2016-12-12', 9500000, '2016-08-31'),
(7, 3, 'a08ZYQbgYOMs', '', '', '', 'asep123', '', '', '23bf71807cbf8d06afe79f43ea3c645ca2a1ec572529bf349b0f2e50a09f86153fafcc9aaba730db2f2645262dab6184c0fb79097c955d90b4a69ec60eca81d1', 'asep rohman', 'asep@gmail.com', 'Laki-laki', '1993-05-01', '1293178371287217', 'jl. garut malabar garut jawabarat', 'joko wi', 'gartu', 'jawa barat', '08192813728', 'BCA', '12883292', '', 'asep rohman', '', 1, 7, 0, 0, 0, '2016-12-12', 9500000, '2016-08-31'),
(8, 3, 'YeVngsMXP8XE', 'asep123', 'asep123', '0', 'dingding', '', '', '23bf71807cbf8d06afe79f43ea3c645ca2a1ec572529bf349b0f2e50a09f86153fafcc9aaba730db2f2645262dab6184c0fb79097c955d90b4a69ec60eca81d1', 'dingding dongdong', 'dingding@gmail.com', 'Perempuan', '2000-04-03', '128317183', 'jl. sombong dong bandung jawabarat', 'agus dong', 'bandung', 'jawabarat', '08231372323', 'Mandiri', '123812332', '', 'dingding dongdong', '', 0, 0, 0, 0, 0, '2016-12-12', 9500000, '2016-08-31'),
(9, 1, 'aYJTLwnOryYA', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(10, 2, 'lAJFcVMbbeKZ', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(11, 2, 'gVRZqXMPRZ4M', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(12, 1, 'SCycVeASsUSJ', '', '', '', '', '', '', '', 'Robby Prihadnaya1', 'robby@gmail.com', 'Laki-laki', '1961-02-09', '4563524243', 'dfgdfgdfgdfg', 'dfgdfgdf', 'dfgdfgdfgdfg', '4eytertertert', '456345345345345', 'sfsdfsdfdsf', '3453535', '', 'dgdfgdfgdfgf', '', 0, 2, 0, 2, 0, '2016-12-12', 1500000, '2016-12-12'),
(13, 1, 'iGjrskCNo2r0', '', '', '', '', '', '', '', 'Robby Perwakilan2', 'robbyretyert@gmail.com', 'Laki-laki', '1970-04-16', '34542423', 'sdsdfsdfsdf', 'dsfgsdfsdfsd', 'Sumatera Barat', 'sdfsfddsfsdf', '34534534534534', 'Sistem Informasi', '3453453453', '', 'sdsdfsdfsdf', '', 0, 0, 0, 0, 0, '2016-12-12', 1500000, '2016-12-12'),
(14, 1, 'aCTvOInhLc0g', 'robby', 'tommy', '0', 'robby1', '', '', '6b03350bef044d6af47a18a51d24ba93e2bb63002b91c7b744561a5b201f35ffc5e7c17c0746d8ccd466e5fd413fded4b11711be097b53fe3a2decb58e5fe01b', 'Robby Perwakilan', 'robby.perwakilan@gmail.com', 'Laki-laki', '1963-06-18', '45635345435345', 'dfgdfgfdgfdgdg', 'Padang', 'gdfg fgfdgd', 'tr ytrhfhft', '5463566465', 'mandiri', '4354524234', '', 'Robby 1', '', 0, 0, 0, 0, 0, '2016-12-12', 1500000, '2016-12-12'),
(15, 3, 'A4sBkpxH0x06', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(16, 2, 'ux2i8KfTSHO6', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(17, 2, 'FEKmKC3G5dek', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(18, 2, 'JVizNHMA8vA2', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(19, 1, '1WR99xS35tlF', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(20, 1, 'AnSxEc9udrrI', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(21, 1, 'ETGsKwPpoCut', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00'),
(22, 1, 'zkrHiXqjL4xQ', '', '', '', '', '', '', '', '', '', 'Laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '2016-12-12', 0, '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `rb_konsumen_order`
--

CREATE TABLE `rb_konsumen_order` (
  `id_konsumen_order` int(10) NOT NULL,
  `id_pembeli` int(11) NOT NULL,
  `id_penjual` int(11) NOT NULL,
  `id_produk` int(5) NOT NULL,
  `jumlah` int(10) NOT NULL,
  `keterangan` text NOT NULL,
  `pembeli` enum('konsumen','agen','distributor') NOT NULL,
  `penjual` enum('agen','distributor','perwakilan') NOT NULL,
  `waktu_order` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rb_konsumen_order`
--

INSERT INTO `rb_konsumen_order` (`id_konsumen_order`, `id_pembeli`, `id_penjual`, `id_produk`, `jumlah`, `keterangan`, `pembeli`, `penjual`, `waktu_order`) VALUES
(1, 1, 1, 2, 2, 'Sudah Dibayar,..', 'konsumen', 'agen', '2016-08-31 08:34:09'),
(2, 1, 1, 1, 1, 'Sudah Dibayar,..', 'konsumen', 'agen', '2016-08-31 08:34:22'),
(3, 2, 1, 2, 1, 'Lunas,...', 'konsumen', 'agen', '2016-11-07 09:42:11'),
(4, 1, 1, 3, 1, 'Lunas,...', 'konsumen', 'agen', '2016-11-08 07:12:32'),
(5, 1, 1, 1, 1, 'Lunas,...', 'konsumen', 'agen', '2016-12-10 15:10:41'),
(6, 1, 1, 1, 1, 'Lunas,...', 'konsumen', 'distributor', '2016-12-10 15:19:05'),
(7, 1, 1, 2, 5, 'Lunas,...', 'agen', 'distributor', '2016-12-10 15:19:26'),
(8, 1, 1, 2, 1, 'Lunas,...', 'konsumen', 'perwakilan', '2016-12-10 15:23:48'),
(9, 1, 1, 2, 2, 'Lunas,...', 'agen', 'perwakilan', '2016-12-10 15:23:58'),
(10, 1, 1, 2, 3, 'Lunas,...', 'distributor', 'perwakilan', '2016-12-10 15:24:17');
...
INSERT INTO `rb_order_kode` (`id_order_kode`, `jumlah`, `id_paket`, `nama_lengkap`, `alamat_email`, `no_hp`, `kota`, `nama_bank`, `no_rekening`, `pemilik_rekening`, `waktu_order`) VALUES
(1, 1, 1, 'Robby Prihandaya', 'robby.prihandaya@gmail.com', '081267771344', 'Padang', 'BRI', '540011132323112', 'Robby Prihandaya', '2016-08-31 08:53:39'),
(2, 1, 3, 'Dewiit Safitri', 'dewiit.safitri@gmail.com', '082173054500', 'Padang', 'BCA', '562342423423', 'Dewiit Safitri', '2016-08-31 08:55:36'),
(3, 2, 3, 'asep rohman', 'asep@gmail.com', '08192813728', 'bandung', 'BCA', '12883292', 'asep rohman', '2016-08-31 23:27:13');
...
(1, 1, 'lAJFcVMbbeKZ', '2016-09-14 07:00:15'),
(2, 1, 'gVRZqXMPRZ4M', '2016-09-14 07:00:15'),
(3, 2, 'SCycVeASsUSJ', '2016-09-14 07:11:38'),
(4, 2, 'iGjrskCNo2r0', '2016-09-14 07:11:38'),
(5, 2, 'aCTvOInhLc0g', '2016-09-14 07:11:38'),
(6, 3, 'A4sBkpxH0x06', '2016-11-07 09:30:20'),
(7, 4, 'ux2i8KfTSHO6', '2016-11-07 09:53:24'),
(8, 4, 'FEKmKC3G5dek', '2016-11-07 09:53:24'),
(9, 4, 'JVizNHMA8vA2', '2016-11-07 09:53:24'),
(12, 7, 'ETGsKwPpoCut', '2016-12-10 15:38:20'),
(13, 7, 'zkrHiXqjL4xQ', '2016-12-10 15:38:20');
...
INSERT INTO `rb_order_kode_konsumen` (`id_order_kode_konsumen`, `id_konsumen`, `id_paket`, `jumlah`, `keterangan`, `status`, `waktu_order`) VALUES
(1, 1, 2, 2, 'Mohon Segera DI Proses om admin,..', 'agen', '2016-09-14 17:07:23'),
(2, 1, 1, 3, 'Mohon Segera Di Proses, Untuk Pembayaran segera saya lunasi,..', 'konsumen', '2016-09-14 19:49:23'),
(3, 1, 3, 1, 'Mohon Segera Di Proses admin sayang,.', 'distributor', '2016-09-14 07:06:53'),
(4, 1, 2, 3, 'Sudah saya transfer ke rek Mandiri Rp 12.000.000,..', 'distributor', '2016-11-07 09:38:02'),
(5, 1, 2, 2, 'Saya sudah transfer 8.000.000 Ke rekening BCA,..', 'konsumen', '2016-11-07 09:40:50'),
(6, 1, 1, 1, 'Sudah saya transferkan 1.500.00,..', 'agen', '2016-11-07 09:44:00'),
(7, 1, 1, 2, 'Saya sudah Transfer ke BRI Rp 3.000.000 boz,..', 'perwakilan', '2016-12-10 15:25:25'),
(8, 1, 2, 1, 'Sudah saya transferkan ke BCA,..', 'perwakilan', '2016-12-10 15:25:41');
...
CREATE TABLE `rb_paket` (
  ...
  `total_rp` float NOT NULL,
  `min_paket` int(5) NOT NULL,
  `max_paket` int(5) NOT NULL,
  `nilai_produk` int(10) NOT NULL,
  `lainnya` varchar(255) NOT NULL,
  `potensi_penghasilan` int(10) NOT NULL,
  `bonus_sponsorisasi` int(10) NOT NULL,
  `keterangan` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `rb_paket` (`id_paket`, `nama_paket`, `total_rp`, `min_paket`, `max_paket`, `nilai_produk`, `lainnya`, `potensi_penghasilan`, `bonus_sponsorisasi`, `keterangan`) VALUES
(1, 'MASTER', 1500000, 1, 12, 750000, '1 DP WISATA', 1200000, 500000, '12 PASANG PER HARI'),
(2, 'GOLD', 4000000, 3, 24, 2250000, '3 DP WISATA', 2400000, 1000000, '24 PASANG PER HARI'),
(3, 'PLATINUM', 9500000, 7, 50, 6000000, '7 DP WISATA', 5000000, 2500000, '50 PASANG PER HARI');
...
CREATE TABLE `rb_pembayaran_bonus` (
  ...
  `username` varchar(60) NOT NULL,
  `bonus_pasangan` int(10) NOT NULL,
  `bonus_sponsor` int(10) NOT NULL,
  `bonus_tabungan` int(10) NOT NULL,
  `bonus_ro` int(10) NOT NULL,
...
INSERT INTO `rb_pembayaran_bonus` (`id_pembayaran_bonus`, `username`, `bonus_pasangan`, `bonus_sponsor`, `bonus_tabungan`, `bonus_ro`, `waktu_bayar`) VALUES
(1, 'robby', 300000, 500000, 3500, 0, '2016-08-31');

-- --------------------------------------------------------

--
-- Table structure for table `rb_pencairan`
--

CREATE TABLE `rb_pencairan` (
  `id_pencairan` int(10) NOT NULL,
...
--
-- Table structure for table `rb_perwakilan`
--

CREATE TABLE `rb_perwakilan` (
  `id_perwakilan` int(5) NOT NULL,
  `username` varchar(100) NOT NULL,
  `password` text NOT NULL,
  `nama_perwakilan` varchar(150) NOT NULL,
  `tempat_lahir` varchar(100) NOT NULL,
  `tanggal_lahir` date NOT NULL,
  `no_ktp_sim` varchar(50) NOT NULL,
  `email` varchar(150) NOT NULL,
...
--
-- Dumping data for table `rb_perwakilan`
--

INSERT INTO `rb_perwakilan` (`id_perwakilan`, `username`, `password`, `nama_perwakilan`, `tempat_lahir`, `tanggal_lahir`, `no_ktp_sim`, `email`, `alamat_lengkap`, `kota`, `provinsi`, `kode_pos`, `telp_hp`, `waktu_daftar`, `aktif`) VALUES
(1, 'perwakilan', 'aaa9bfba7135b125234a87f9ba596c211997840dfa35f1655b8ffaf7d862e8d1537cd2ba10a7b4faf1177206235880e3336624f7fec67bdbdfd6bd68023be920', 'Robby Perwakilan', 'Padang', '1989-05-13', '6734563454533435', 'distributor@gmail.com', 'Jl Angkasa Puri, Tunggul Hitam', 'Padang', 'Sumatera Barat', 26125, '081267771344', '2016-11-05 19:33:16', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `rb_perwakilan_order`
--

CREATE TABLE `rb_perwakilan_order` (
  `id_perwakilan_order` int(10) NOT NULL,
  `id_perwakilan` int(5) NOT NULL,
  `id_produk` int(5) NOT NULL,
  `jumlah` int(10) NOT NULL,
  `keterangan` text NOT NULL,
...
--
-- Dumping data for table `rb_perwakilan_order`
--

INSERT INTO `rb_perwakilan_order` (`id_perwakilan_order`, `id_perwakilan`, `id_produk`, `jumlah`, `keterangan`, `waktu_order`) VALUES
(1, 1, 6, 6, 'Lunas', '2016-11-05 20:32:03'),
(2, 1, 2, 7, 'Lunas', '2016-11-05 20:42:26'),
(26, 1, 3, 9, 'Lunas,..', '2016-12-10 15:35:40');
...
CREATE TABLE `rb_produk` (
  ...
  `agen` int(10) NOT NULL,
  `konsumen` int(10) NOT NULL,
...
INSERT INTO `rb_produk` (`id_produk`, `nama_produk`, `cabang`, `distributor`, `agen`, `konsumen`, `stok`, `status`) VALUES
(1, 'POCL Biota Plus', 75000, 80000, 95000, 125000, 354, 'Y'),
(2, 'Pestisida Nabati', 70000, 76000, 82500, 95000, 255, 'Y'),
(3, 'Pestisida Kimiawi', 72000, 75000, 80000, 85000, 800, 'Y');
...
--
-- Table structure for table `rb_reword`
--

CREATE TABLE `rb_reword` (
  `id_reword` int(5) NOT NULL,
  `posisi` varchar(100) NOT NULL,
  `ket_kanan` varchar(255) NOT NULL,
  `ket_kiri` varchar(255) NOT NULL,
  `reword` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rb_reword`
--

INSERT INTO `rb_reword` (`id_reword`, `posisi`, `ket_kanan`, `ket_kiri`, `reword`) VALUES
(1, 'SILVER', '25', '25', 'HP (2,5 JT)'),
(2, 'EXECUTIVE', '3 SILVER', '3 SILVER', 'LEPTOP (5 JT)'),
(3, 'MANAGER', '3 EXECUTIVE', '3 EXECUTIVE', 'UMROH (25 JT)'),
(4, 'DIAMOND', '3 MANAGER', '3 MANAGER', 'MOBIL (125. JT)'),
(5, 'DIREKTUR', '3 DIAMOND', '3 DIAMOND', 'MOBIL (500 JT)'),
(6, 'CROWN', '3 DIREKTUR', '3 DIREKTUR', 'RUMAH (1 M)');
...
CREATE TABLE `rb_setting` (
  ...
  `bonus_pasangan` int(11) NOT NULL,
  `bonus_tabungan` int(11) NOT NULL,
  `gen_tabungan` int(11) NOT NULL,
  `min_bonus_ro` int(11) NOT NULL,
  `persen_ro` varchar(11) NOT NULL,
  `gen_ro` int(11) NOT NULL,
  `persen_auto_save` int(11) NOT NULL,
  `max_auto_save` int(11) NOT NULL,
  `ppn` int(11) NOT NULL,
  `aktif` enum('Y','N') NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `rb_setting` (`id_setting`, `bonus_pasangan`, `bonus_tabungan`, `gen_tabungan`, `min_bonus_ro`, `persen_ro`, `gen_ro`, `persen_auto_save`, `max_auto_save`, `ppn`, `aktif`) VALUES
(1, 100000, 3500, 5, 400000, '2.5', 10, 20, 1000000, 10, 'Y');
...
(1, 'dewiit', 'robby', 2500000, '2016-08-31 09:02:44'),
(2, 'tommy', 'robby', 1000000, '2016-08-31 09:04:56'),
(3, 'dingding', 'asep123', 2500000, '2016-08-31 23:35:46'),
(4, 'laura', 'robby', 500000, '2016-09-15 22:32:00'),
(10, 'robby1', 'robby', 500000, '2016-12-12 10:46:45');

-- --------------------------------------------------------

--
-- Table structure for table `rb_struktur_sponsor_level`
--

CREATE TABLE `rb_struktur_sponsor_level` (
...
--
-- Dumping data for table `rb_struktur_sponsor_level`
--

INSERT INTO `rb_struktur_sponsor_level` (`id_struktur_sponsor_level`, `username`, `sponsor`, `level`, `timer`) VALUES
(1, 'dewiit', 'robby', 1, '2016-08-31 09:02:44'),
(2, 'tommy', 'robby', 1, '2016-08-31 09:04:56'),
(3, 'dingding', 'asep123', 1, '2016-08-31 23:35:46'),
(4, 'laura', 'robby', 1, '2016-09-15 22:32:00'),
(10, 'robby1', 'robby', 1, '2016-12-12 10:46:45');

-- --------------------------------------------------------

--
-- Table structure for table `rb_tabungan`
--

CREATE TABLE `rb_tabungan` (
...
--
-- Table structure for table `rb_upgrade`
--

CREATE TABLE `rb_upgrade` (
  `id_upgrade` int(10) NOT NULL,
  `id_konsumen` int(10) NOT NULL,
  `id_paket_lama` int(5) NOT NULL,
  `id_paket` int(5) NOT NULL,
  `keterangan` text NOT NULL,
...
--
-- Dumping data for table `rb_upgrade`
--

INSERT INTO `rb_upgrade` (`id_upgrade`, `id_konsumen`, `id_paket_lama`, `id_paket`, `keterangan`, `waktu_request`, `status`) VALUES
(1, 1, 1, 2, 'Saya mau upgrade akun, mohon dibantu,..', '2016-08-31 09:16:15', 1);
...
--
-- Indexes for table `rb_agen`
--
ALTER TABLE `rb_agen`
  ADD PRIMARY KEY (`id_agen`);

--
-- Indexes for table `rb_agen_order`
--
ALTER TABLE `rb_agen_order`
  ADD PRIMARY KEY (`id_agen_order`);

--
-- Indexes for table `rb_bonus_ro`
--
ALTER TABLE `rb_bonus_ro`
  ADD PRIMARY KEY (`id_bonus_ro`);

--
-- Indexes for table `rb_bonus_tabungan`
--
ALTER TABLE `rb_bonus_tabungan`
  ADD PRIMARY KEY (`id_bonus_tabungan`);

--
-- Indexes for table `rb_distributor`
--
ALTER TABLE `rb_distributor`
  ADD PRIMARY KEY (`id_distributor`);

--
-- Indexes for table `rb_distributor_order`
--
ALTER TABLE `rb_distributor_order`
  ADD PRIMARY KEY (`id_distributor_order`);

--
-- Indexes for table `rb_foot`
--
ALTER TABLE `rb_foot`
  ADD PRIMARY KEY (`id_foot`);

--
-- Indexes for table `rb_foot_detail`
--
ALTER TABLE `rb_foot_detail`
  ADD PRIMARY KEY (`id_foot`);
...
--
-- Indexes for table `rb_konsumen_order`
--
ALTER TABLE `rb_konsumen_order`
...
--
-- Indexes for table `rb_pencairan`
--
ALTER TABLE `rb_pencairan`
  ADD PRIMARY KEY (`id_pencairan`);

--
-- Indexes for table `rb_perwakilan`
--
ALTER TABLE `rb_perwakilan`
  ADD PRIMARY KEY (`id_perwakilan`);

--
-- Indexes for table `rb_perwakilan_order`
--
ALTER TABLE `rb_perwakilan_order`
  ADD PRIMARY KEY (`id_perwakilan_order`);
...
--
-- Indexes for table `rb_reword`
--
ALTER TABLE `rb_reword`
  ADD PRIMARY KEY (`id_reword`);
...
--
-- Indexes for table `rb_struktur_sponsor_level`
--
ALTER TABLE `rb_struktur_sponsor_level`
  ADD PRIMARY KEY (`id_struktur_sponsor_level`);

--
-- Indexes for table `rb_tabungan`
--
ALTER TABLE `rb_tabungan`
...
--
-- Indexes for table `rb_upgrade`
--
ALTER TABLE `rb_upgrade`
...
--
-- AUTO_INCREMENT for table `rb_agen`
--
ALTER TABLE `rb_agen`
  MODIFY `id_agen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `rb_agen_order`
--
ALTER TABLE `rb_agen_order`
  MODIFY `id_agen_order` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `rb_bonus_ro`
--
ALTER TABLE `rb_bonus_ro`
  MODIFY `id_bonus_ro` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rb_bonus_tabungan`
--
ALTER TABLE `rb_bonus_tabungan`
  MODIFY `id_bonus_tabungan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rb_distributor`
--
ALTER TABLE `rb_distributor`
  MODIFY `id_distributor` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `rb_distributor_order`
--
ALTER TABLE `rb_distributor_order`
  MODIFY `id_distributor_order` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `rb_foot`
--
ALTER TABLE `rb_foot`
  MODIFY `id_foot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `rb_foot_detail`
--
ALTER TABLE `rb_foot_detail`
  MODIFY `id_foot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `rb_konsumen`
  MODIFY `id_konsumen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `rb_konsumen_order`
--
ALTER TABLE `rb_konsumen_order`
  MODIFY `id_konsumen_order` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `rb_order_kode_kirim`
  MODIFY `id_order_kode_kirim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `rb_order_kode_konsumen`
--
ALTER TABLE `rb_order_kode_konsumen`
  MODIFY `id_order_kode_konsumen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `rb_pembayaran_bonus`
  MODIFY `id_pembayaran_bonus` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rb_pencairan`
--
ALTER TABLE `rb_pencairan`
  MODIFY `id_pencairan` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rb_perwakilan`
--
ALTER TABLE `rb_perwakilan`
  MODIFY `id_perwakilan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `rb_perwakilan_order`
--
ALTER TABLE `rb_perwakilan_order`
  MODIFY `id_perwakilan_order` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
...
--
-- AUTO_INCREMENT for table `rb_reword`
--
ALTER TABLE `rb_reword`
  MODIFY `id_reword` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
-- AUTO_INCREMENT for table `rb_struktur_sponsor_level`
--
ALTER TABLE `rb_struktur_sponsor_level`
  MODIFY `id_struktur_sponsor_level` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `rb_tabungan`
--
ALTER TABLE `rb_tabungan`
...
--
ALTER TABLE `rb_tabungan_bayar`
  MODIFY `id_tabungan_bayar` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `rb_upgrade`
--
ALTER TABLE `rb_upgrade`
  MODIFY `id_upgrade` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
