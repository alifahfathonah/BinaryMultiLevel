...
class Model_main extends CI_model{
    ...
    function settingbonus_update(){
                    $datadb = array('bonus_pasangan'=>$this->db->escape_str($this->input->post('a')),
                                    'bonus_tabungan'=>$this->db->escape_str($this->input->post('b')),
                                    'gen_tabungan'=>$this->db->escape_str($this->input->post('c')),
                                    'min_bonus_ro'=>$this->db->escape_str($this->input->post('d')),
                                    'persen_ro'=>$this->db->escape_str($this->input->post('e')),
                                    'gen_ro'=>$this->db->escape_str($this->input->post('f')),
                                    'persen_auto_save'=>$this->db->escape_str($this->input->post('g')),
                                    'max_auto_save'=>$this->db->escape_str($this->input->post('h')),
                                    'ppn'=>$this->db->escape_str($this->input->post('i')));
