      <div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Detail Data Perwakilan </h3>
                  <a class='btn btn-success btn-sm pull-right' href='<?php echo base_url(); ?>perwakilan/edit_perwakilan/<?php echo $this->uri->segment(3); ?>'>Edit Profile</a>
                </div>
                <div class='box-body'>

                  <div class='panel-body'>
                    <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                      <li role='presentation' class='active'><a href='#profile' id='profile-tab' role='tab' data-toggle='tab' aria-controls='profile' aria-expanded='true'>Data Perwakilan </a></li>
                      ...
                      <li role='presentation' class=''><a href='#penjualan3' role='tab' id='penjualan3-tab' data-toggle='tab' aria-controls='penjualan3' aria-expanded='false'>Data Penjualan ke Cabang</a></li>
                    </ul><br>
                    ...
                    <div id='myTabContent' class='tab-content'>
                      <div role='tabpanel' class='tab-pane fade active in' id='profile' aria-labelledby='profile-tab'>
                          <div class='col-md-6'>
                            ...
                            <tbody>
                              ...
                              <tr><th scope='row'>Nama Perwakilan</th> <td><?php echo $rows['nama_perwakilan']?></td></tr>
                          ...
                          <div class='col-md-12'>
                            <table class='table table-condensed table-bordered'>
                              ...
                              <?php
                                ...
                                $jual = $this->db->query("SELECT sum(jumlah) as jumlah FROM rb_konsumen_order where id_penjual='$rows[id_perwakilan]' AND id_produk='$row[id_produk]' AND penjual='perwakilan'")->row_array();
                                echo "<tr><td>$no</td>
                      ...
                      <div role='tabpanel' class='tab-pane fade' id='penjualan2' aria-labelledby='penjualan2-tab'>
                          <div class='col-md-12'>
                            <table class='table table-condensed table-bordered'>
                              <thead>
                                <tr bgcolor='#e3e3e3'>
                      ...
                      <div role='tabpanel' class='tab-pane fade' id='penjualan3' aria-labelledby='penjualan3-tab'>
                          <div class='col-md-12'>
                            <table class='table table-condensed table-bordered'>
                              <thead>
                                <tr bgcolor='#e3e3e3'>
                              ...
                              <?php
                                $no = 1;
                                foreach ($penjualan_distributor->result_array() as $row){
                                $ex = explode(' ',$row['waktu_order']);
                                echo "<tr><td>$no</td>
                                          <td><a href='#'>$row[nama_distributor]</a></td>
                                          <td>$row[nama_produk]</td>
                                          <td align=center>".rupiah($row['jumlah'])."</td>
                                          <td>$row[keterangan]</td>
                                          <td>".tgl_indo($ex[0]).", ".$ex[1]." WIB</td>
