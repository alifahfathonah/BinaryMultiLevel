    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Level</th>                    <td><input type='radio' name='g' value='user'> Users Biasa &nbsp; <input type='radio' name='g' value='admin'> Administrator </td></tr>
                  ...
                  <b>Hak Akses :</b><br>";
                      ...
                      foreach ($mo->result_array() as $mode){
                        echo "<span style='display:inline-block;'><input type=checkbox value='$mode[id_modul]' name='i".$no."'>$mode[nama_modul] &nbsp; &nbsp; </span>";
                      $no++;
                      }
                echo "</div>
              </div>
