      <div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  ...
                  <a class='btn btn-success btn-sm pull-right' href='<?php echo base_url(); ?>administrator/edit_perwakilan/<?php echo $this->uri->segment(3); ?>'>Edit Profile</a>
                </div>
                <div class='box-body'>
                      ...
                      <div role='tabpanel' class='tab-pane fade active in' id='profile' aria-labelledby='profile-tab'>
                          <div class='col-md-6'>
                            ...
                            <tbody>
                              ...
                              <tr><th scope='row'>Nama Cabang</th> <td><?php echo $rows['nama_perwakilan']?></td></tr>
