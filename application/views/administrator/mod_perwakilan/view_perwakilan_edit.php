    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Data perwakilan</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_perwakilan',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$rows[id_perwakilan]'>
                    <tr><th width='130px' scope='row'>Username</th>   <td><input type='text' class='form-control' name='a' value='$rows[username]' required></td></tr>
                    <tr><th scope='row'>Password</th>                 <td><input type='password' class='form-control' name='b'></td></tr>
                    <tr><th scope='row'>Nama Perwakilan</th>         <td><input type='text' class='form-control' name='c' value='$rows[nama_perwakilan]' required></td></tr>
                    ...
                    <tr><th scope='row'>Aktif</th>                        <td>"; if ($rows['aktif']=='Y'){ echo "<input type='radio' name='m' value='Y' checked> Ya &nbsp; <input type='radio' name='m' value='N'> Tidak"; }else{ echo "<input type='radio' name='m' value='Y'> Ya &nbsp; <input type='radio' name='m' value='N' checked> Tidak"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
