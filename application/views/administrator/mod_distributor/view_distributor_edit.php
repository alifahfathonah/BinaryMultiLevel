<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_distributor',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$rows[id_distributor]'>
                    ...
                    <tr><th scope='row'>Nama Distributor</th>         <td><input type='text' class='form-control' name='c' value='$rows[nama_distributor]' required></td></tr>
