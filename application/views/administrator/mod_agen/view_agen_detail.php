      <div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  ...
                  <a class='btn btn-success btn-sm pull-right' href='<?php echo base_url(); ?>administrator/edit_agen/<?php echo $this->uri->segment(3); ?>'>Edit Profile</a>
                </div>
                <div class='box-body'>
                  ...
                  <div class='panel-body'>
                    <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                      ...
                      <li role='presentation' class=''><a href='#pembeliandist' role='tab' id='pembeliandist-tab' data-toggle='tab' aria-controls='pembeliandist' aria-expanded='false'>Data Pembelian ke Cabang</a></li>
