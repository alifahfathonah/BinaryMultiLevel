...
<?php
        echo "<div class='pull-right'>
                <a class='btn btn-xs btn-primary' href='".base_url()."distributor/tambah_orderkode'>Order Kode Aktivasi</a>
        ...
        echo "<table id='example2' class='table table-bordered table-striped'>
            <thead>
              ...
              echo "<tr>
                    ...
                    <td>$status</td>
                    <td><a style='padding-left; 6px; padding-right:6px' class='btn btn-xs btn-success' href='".base_url()."distributor/detail_orderkode/$row[id_order_kode_konsumen]'><span class='glyphicon glyphicon-shopping-cart'></span> Lihat Pesanan</a></td>
                  </tr>";
                $no++;
              }
            echo "</tbody></table>
