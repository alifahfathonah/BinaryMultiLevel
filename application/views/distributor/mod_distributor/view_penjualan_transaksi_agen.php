    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Transaksi Penjualan Produk ke Agen</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('distributor/tambah_penjualan_agen',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='d' value='agen'>
                    ...
                    <tr><th width='120px' scope='row'>Nama Agen</th><td><input type='text' class='form-control' value='$nama_konsumen' required disabled></td></tr>
