      <div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  ...
                  <a class='btn btn-success btn-sm pull-right' href='<?php echo base_url(); ?>distributor/edit_distributor/<?php echo $this->uri->segment(3); ?>'>Edit Profile</a>
                </div>
                <div class='box-body'>
                          ...
                          <div class='col-md-12'>
                            <table class='table table-condensed table-bordered'>
                              ...
                              <?php
                                ...
                                $jual = $this->db->query("SELECT sum(jumlah) as jumlah FROM rb_konsumen_order where id_penjual='$rows[id_distributor]' AND id_produk='$row[id_produk]' AND penjual='distributor'")->row_array();
                                echo "<tr><td>$no</td>
