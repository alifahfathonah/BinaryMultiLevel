...
<?php                
                  ...
                  echo form_open_multipart('distributor/tambah_orderkode',$attributes); 
                  $usr = $this->db->query("SELECT * FROM rb_distributor where id_distributor='".$this->session->id."'")->row_array();
                  echo "<table class='table table-hover'>
                        <thead>
                          <tr><td width='130px'><b>Nama Distributor</b></td>     <td><input type='text' class='form-control' value='$usr[nama_distributor]' disabled></td></tr>
