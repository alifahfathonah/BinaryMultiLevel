            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='<?php echo base_url(); ?>distributor/tambah_penjualan_konsumen' method='POST'>
                    ...
                    <thead>
                              ...
                              <?php
                                ...
                                echo "<tr><td>$no</td>
                                          ...
                                          <td>".tgl_indo($ex[0])."</td>
                                          <td><a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."distributor/delete_penjualan_konsumen/$row[id_konsumen_order]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a></td>
                                      </tr>";
                                  $no++;
                                }
                              ?>
