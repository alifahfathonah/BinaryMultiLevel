    ...
    <div class="modal-content">
      ...
      ?>
        ...
        <div class="form-group">
          ...
          <div class='col-sm-9'>
          <div style='background:#fff;' class="input-group col-sm-3">
        ...
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-3 control-label">Pilih Paket</label>
          <div class='col-sm-9'>
          <div style='background:#fff;' class="input-group col-sm-10">
            <select class='required form-control' name='paket' required>
