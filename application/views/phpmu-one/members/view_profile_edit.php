           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";                
                  ...
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td><b>Nama Bank</b></td>              <td><input style='width:60%' class='required form-control' type='text' name='l' value='$row[nama_bank]' disabled></td></tr>
                          <tr><td><b>No Rekening</b></td>            <td><input style='width:60%' class='required number form-control' type='number' name='m' value='$row[no_rekening]' disabled></td></tr>
                          <tr><td><b>Atas Nama</b></td>              <td><input class='required form-control' type='text' name='n' value='$row[atas_nama]' disabled></td></tr></td></tr>
