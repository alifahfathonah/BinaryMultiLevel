           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";                
                  ...
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td><b>Username Sponsor</b></td>       <td>$row[sponsor]</td></tr>
                          <tr><td><b>Nama Penempatan</b></td>        <td>$penempatan</td></tr>
                          <tr><td><b>Nama Paket</b></td>             <td><b style='color:$color'>$row[nama_paket]</b></td></tr>
                        </thead>
                    </table>";
?>