            ...
            echo form_open_multipart('members/tambah_jaringan/'.$username.'/'.$posisi,$attributes); 
              echo "<div class='form-group'>
                        ...
                        <div style='background:#fff;' class='input-group col-sm-6'>
                            <input type='text' class='required form-control' id='kodeaktivasi' name='kode' minlength='5' value='".$this->input->post('kode')."'>
                        </div>
                        </div>
                    </div>
                    ...
                    <div style='padding:8px; border-bottom:2px solid #337ab7' class='alert alert-info'>
                        <strong>PENEMPATAN & PAKET</strong>
                    </div>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-9'>
                        <div style='background:#fff;' class='input-group col-sm-8'>
                            <input type='text' class='required form-control' name='sps' id='sponsor' value='".$this->session->username."'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-9'>
                        <div style='background:#fff;' class='input-group col-sm-8'>
                            <input type='text' class='required form-control' name='upl' value='".$this->uri->segment(3)."'>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-9'>
                        <div style='background:#fff;' class='input-group col-sm-8'>
                            <label generated='true' style='border:1px solid #cecece; padding:6px; width:100%' id='messagekode'></label>
                        </div>
                        </div>
                    </div>
